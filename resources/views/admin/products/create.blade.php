    ...
    <div class="row justify-content-center">
        <div class="col-lg-8">
            <div class="card border-0 shadow-sm">
                <div class="card-body">
                    <h5 class="card-title fw-bold mb-3">New Product</h5>
                    ...
                    <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="care_level" id="care_level" class="form-select @error('care_level') is-invalid @enderror">
                                ...
                                <option value="mudah" {{ old('care_level', '') === 'mudah' ? 'selected' : '' }}>Mudah</option>
                                <option value="sedang" {{ old('care_level', '') === 'sedang' ? 'selected' : '' }}>Perawatan Sedang</option>
                                <option value="perlu_perhatian" {{ old('care_level', '') === 'perlu_perhatian' ? 'selected' : '' }}>Perlu Perhatian</option>
                            </select>
                            @error('care_level')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="placement_type" id="placement_type" class="form-select @error('placement_type') is-invalid @enderror">
                                <option value="">-- Pilih --</option>
                                <option value="dalam_ruangan" {{ old('placement_type', '') === 'dalam_ruangan' ? 'selected' : '' }}>Dalam Ruangan</option>
                                <option value="luar_ruangan" {{ old('placement_type', '') === 'luar_ruangan' ? 'selected' : '' }}>Luar Ruangan</option>
                                <option value="keduanya" {{ old('placement_type', '') === 'keduanya' ? 'selected' : '' }}>Keduanya</option>
                            </select>
